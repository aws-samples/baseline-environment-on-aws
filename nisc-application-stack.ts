  ...
  constructor(scope: cdk.Construct, id: string, props: NiscApplicationStackProps) {
    super(scope, id, props);
      ...
      const securityGroupFroApp = new ec2.SecurityGroup(this, 'rSecurityGroupApp', {
        vpc: props.prodVpc,
        securityGroupName: 'sg-app-server-elb',
      ...
      const securityGroupFroAppInstance = new ec2.SecurityGroup(this, 'rSecurityGroupAppInstance', {
        vpc: props.prodVpc,
        securityGroupName: 'sg-app-server-elb-instances',
      ...
      const securityGroupFroWeb = new ec2.SecurityGroup(this, 'rSecurityGroupWeb', {
        vpc: props.prodVpc,
        securityGroupName: 'sg-reverse-proxy-dmz',
      ...
      const securityGroupFroWebInstance = new ec2.SecurityGroup(this, 'rSecurityGroupWebInstance', {
        vpc: props.prodVpc,
        securityGroupName: 'sg-reverse-proxy-dmz-instances',
      ...
      const securityGroupFroRDS = new ec2.SecurityGroup(this, 'rSecurityGroupRDS', {
        vpc: props.prodVpc,
        securityGroupName: 'sg-database-access',
      ...
      policyForLoggingBucket.addResources('arn:aws:s3:::${rS3ELBAccessLogs}/Logs/AWSLogs/${AWS::AccountId}/*');
      ...
      //add Policy for S3 of Web Content 
      //EnforceSecureTransport
      const EnforceSecureTransportForWebContent = new iam.PolicyStatement({
        effect: iam.Effect.DENY,
        sid: 'EnforceSecureTransport',
      });
      EnforceSecureTransportForWebContent.addActions('s3:*');
      EnforceSecureTransportForWebContent.addResources('arn:aws:s3:::${rWebContentBucket}');
      EnforceSecureTransportForWebContent.addAnyPrincipal;
      EnforceSecureTransportForWebContent.addAwsAccountPrincipal('*');
      EnforceSecureTransportForWebContent.addConditions({
        'Bool': {
           'aws:SecureTransport': 'false' 
        }
      });
      webContentBucket.addToResourcePolicy(EnforceSecureTransportForWebContent);

      //EnforceEncryptionOnPut
      const EnforceEncryptionOnPutForWebContent = new iam.PolicyStatement({
        effect: iam.Effect.DENY,
        sid: 'EnforceEncryptionOnPut',
      });
      EnforceEncryptionOnPutForWebContent.addActions('s3:PutObject');
      EnforceEncryptionOnPutForWebContent.addResources('arn:aws:s3:::${rWebContentBucket}/*');
      EnforceEncryptionOnPutForWebContent.addAnyPrincipal;
      EnforceEncryptionOnPutForWebContent.addAwsAccountPrincipal('*');
      EnforceEncryptionOnPutForWebContent.addConditions({
        'StringNotEquals': {
           's3:x-amz-server-side-encryption': 'AES256' 
        }
      });
      webContentBucket.addToResourcePolicy(EnforceEncryptionOnPutForWebContent);
      ...
      */
      ...
      bind(scope, alarm){
        return {alarmActionArn: autoScalingUpAppPolicy.scalingPolicyArn};
      },});
      ...
      new cw.Alarm(this, 'rCWAlarmLowCPUApp', {
        ...
        bind(scope, alarm){
          return {alarmActionArn: autoScalingDownAppPolicy.scalingPolicyArn};
        },});
      ...
      bind(scope, alarm){
        return {alarmActionArn: autoScalingUpWebPolicy.scalingPolicyArn};
      },});
