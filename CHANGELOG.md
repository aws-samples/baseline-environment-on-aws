...
## [3.2.0](https://github.com/aws-samples/baseline-environment-on-aws/compare/v3.1.0...v3.2.0) (2026-08-24)


### Features

* add FSx for NetApp ONTAP data analytics guest system use case ([#1304](https://github.com/aws-samples/baseline-environment-on-aws/issues/1304)) ([fad18a1](https://github.com/aws-samples/baseline-environment-on-aws/commit/fad18a1dc8d6edffd529f5aaeb336120bfafe92f))
