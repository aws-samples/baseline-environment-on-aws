...
interface NiscLoggingStackProps extends cdk.StackProps {
  notifyEmail: string
}


export class NiscLoggingStack extends cdk.Stack {


  constructor(scope: cdk.Construct, id: string, props: NiscLoggingStackProps) {
    super(scope, id, props);


    // CloudWatch Logs Group for CloudTrail
    const cloudTrailLogGroup = new cwl.LogGroup(this, 'cloudTrailLogGrou', {
