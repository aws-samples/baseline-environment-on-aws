...
interface GcMonitorAlarmStackProps extends cdk.StackProps {
  notifyEmail: string
}


export class GcMonitorAlarmStack extends cdk.Stack {
  public readonly alarmTopic :sns.Topic;

  constructor(scope: cdk.Construct, id: string, props: GcMonitorAlarmStackProps) {
