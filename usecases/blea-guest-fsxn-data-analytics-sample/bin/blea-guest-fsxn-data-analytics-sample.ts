...
new BLEAFsxnDataAnalyticsStack(app, 'Dev-BLEAFsxnDataAnalytics', {
  description: 'BLEA FSxN Data Analytics sample for guest accounts (tag:blea-guest-fsxn-data-analytics-sample)',
  env: {
    account: devParameter.env?.account || process.env.CDK_DEFAULT_ACCOUNT,
    region: devParameter.env?.region || process.env.CDK_DEFAULT_REGION,
  },
  terminationProtection: devParameter.terminationProtection ?? false,
  tags: {
